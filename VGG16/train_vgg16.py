...
model = Sequential()
model.add(VGG16(include_top=False, weights="imagenet", input_shape=(128,128,3), pooling="avg"))
...
model.save("vgg16_50epochsmodel.h5")
...
metrics_df.to_csv('vgg16_50epochsmetrics.csv', index=False)
